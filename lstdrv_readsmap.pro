...
pro lstdrv_readSMAP,pswfits,pmwfits,plwfits,sra,sdec,prfsize,fcat,f_src=f_src,name=name,astromcorr=astromcorr,fcatmod=fcatmod,noseg=noseg,mralims=mralims,mdeclims=mdeclims,segthresh=segthresh,smap=smap
;
;----------------------------------------------------------------------
...
pixsize250=3600.*sxpar(hdr250,"cd2")
